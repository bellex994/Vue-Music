...
export default {
  ...
  data(){
    return{
       artistsArr:["2517","1097","1376","1557","1094","1052","1067","340249647","1095","1133"],
       artistsData:[]
    }
  },
  mounted(){
    for(var i =0;i<this.artistsArr.length;i++){
      const artistsURL = "/v1/restserver/ting?method=baidu.ting.artist.getInfo&tinguid="+ this.artistsArr[i];
