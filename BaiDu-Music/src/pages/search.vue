<template>
  <div class="search">
    ...
    <ul class="list searchlist">
      <router-link tag="li" :to="{name:'MusicPlay',params:{songid:item.songid}}" class="song" v-for="(item,index) in songlist" :key="index">
        <div class="left">
...
<script>
 export default {
   ...
   methods: {
     searchHandler() {
       const searchUrl = '/v1/restserver/ting?method=baidu.ting.search.catalogSug&query=' + this.searchContent
